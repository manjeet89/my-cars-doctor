import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RHSSideAppron.dart';
...
class Exteriorfrontsideroof extends StatefulWidget {
  const Exteriorfrontsideroof({Key? key}) : super(key: key);

  @override
  State<Exteriorfrontsideroof> createState() => _ExteriorfrontsideroofState();
}

class _ExteriorfrontsideroofState extends State<Exteriorfrontsideroof> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior Front Side Roof",
            style: TextStyle(
              color: Colors.white,
