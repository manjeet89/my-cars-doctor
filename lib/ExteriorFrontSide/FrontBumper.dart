import 'dart:io';
import 'package:carinspect/ExteriorFrontSide/Bonnet.dart';
...
class Frontbumper extends StatefulWidget {
  const Frontbumper({Key? key}) : super(key: key);

  @override
  State<Frontbumper> createState() => _FrontbumperState();
}

class _FrontbumperState extends State<Frontbumper> {
  File? _croppedImage;
