import 'dart:io';
import 'package:carinspect/ExteriorFrontSide/ExteriorfrontsideRoof.dart';
...
class Exteriorfrontsidefrontglass extends StatefulWidget {
  const Exteriorfrontsidefrontglass({Key? key}) : super(key: key);

  @override
  State<Exteriorfrontsidefrontglass> createState() =>
      _ExteriorfrontsidefrontglassState();
}

class _ExteriorfrontsidefrontglassState
    extends State<Exteriorfrontsidefrontglass> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorfrontsideroof(),
                          ),
                        );
