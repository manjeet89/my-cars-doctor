import 'dart:io';
import 'package:carinspect/ExteriorBackSide/ExteriorBackSideRearGlass.dart';
...
class Exteriorbacksidedickydoor extends StatefulWidget {
  const Exteriorbacksidedickydoor({Key? key}) : super(key: key);

  @override
  State<Exteriorbacksidedickydoor> createState() =>
      _ExteriorbacksidedickydoorState();
}

class _ExteriorbacksidedickydoorState extends State<Exteriorbacksidedickydoor> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorbacksiderearglass(),
                          ),
                        );
