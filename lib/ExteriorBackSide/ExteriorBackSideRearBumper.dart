import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideLhsSideAppron.dart';
...
class Exteriorbacksiderearbumper extends StatefulWidget {
  const Exteriorbacksiderearbumper({Key? key}) : super(key: key);

  @override
  State<Exteriorbacksiderearbumper> createState() =>
      _ExteriorbacksiderearbumperState();
}

class _ExteriorbacksiderearbumperState
    extends State<Exteriorbacksiderearbumper> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior Back Side Rear Bumper",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior Back Side Rear Bumper",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
