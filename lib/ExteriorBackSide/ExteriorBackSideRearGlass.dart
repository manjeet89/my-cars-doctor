import 'dart:io';
import 'package:carinspect/ExteriorBackSide/ExteriorBackSideDickyFloorCondition.dart';
...
class Exteriorbacksiderearglass extends StatefulWidget {
  const Exteriorbacksiderearglass({Key? key}) : super(key: key);

  @override
  State<Exteriorbacksiderearglass> createState() =>
      _ExteriorbacksiderearglassState();
}

class _ExteriorbacksiderearglassState extends State<Exteriorbacksiderearglass> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior Back Side Rear Glass",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorbacksidedickyfloorcondition(),
                          ),
                        );
