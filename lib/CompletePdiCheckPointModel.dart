class Completepdicheckpointmodel {
  String? pdiId;
  String? pdiPartnerId;
  String? pdiLeadId;
  String? pdiCheckId;
  ...
  Completepdicheckpointmodel.fromJson(Map<String, dynamic> json) {
  ...
  static List<Completepdicheckpointmodel> fromList(
    List<Map<String, dynamic>> list,
  ) {
    return list.map(Completepdicheckpointmodel.fromJson).toList();
  }
