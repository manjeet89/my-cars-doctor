import 'dart:io';
import 'package:carinspect/ChassisDetails.dart/EngineNo.dart';
...
class Chassisno extends StatefulWidget {
  const Chassisno({Key? key}) : super(key: key);

  @override
  State<Chassisno> createState() => _ChassisnoState();
}

class _ChassisnoState extends State<Chassisno> {
  File? _croppedImage;
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Engineno()),
                        );
