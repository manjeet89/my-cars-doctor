import 'dart:io';
import 'package:carinspect/RCandInsuranceDetails/InsuranceType.dart';
...
class Rctype extends StatefulWidget {
  const Rctype({Key? key}) : super(key: key);

  @override
  State<Rctype> createState() => _RctypeState();
}

class _RctypeState extends State<Rctype> {
  File? _croppedImage;
