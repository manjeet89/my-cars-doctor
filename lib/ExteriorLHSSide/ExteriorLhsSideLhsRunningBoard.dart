import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideCPiller.dart';
...
class Exteriorlhssidelhsrunningboard extends StatefulWidget {
  const Exteriorlhssidelhsrunningboard({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidelhsrunningboard> createState() =>
      _ExteriorlhssidelhsrunningboardState();
}

class _ExteriorlhssidelhsrunningboardState
    extends State<Exteriorlhssidelhsrunningboard> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side LHS Running Board",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side LHS Running Board",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorlhssidecpiller(),
                          ),
                        );
