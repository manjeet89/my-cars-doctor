import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideFrontLhsTypePercentage.dart';
...
class Exteriorlhssidelhssideappron extends StatefulWidget {
  const Exteriorlhssidelhssideappron({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidelhssideappron> createState() =>
      _ExteriorlhssidelhssideappronState();
}

class _ExteriorlhssidelhssideappronState
    extends State<Exteriorlhssidelhssideappron> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side LHS Side Appron",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side LHS Side Appron",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Exteriorlhssidefrontlhstypepercentage(),
                          ),
                        );
