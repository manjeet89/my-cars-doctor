import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideRearLhsWindow.dart';
...
class Exteriorlhssiderearlhsdoor extends StatefulWidget {
  const Exteriorlhssiderearlhsdoor({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssiderearlhsdoor> createState() =>
      _ExteriorlhssiderearlhsdoorState();
}

class _ExteriorlhssiderearlhsdoorState
    extends State<Exteriorlhssiderearlhsdoor> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side Rear LHS Door",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side Rear LHS Door",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
