import 'dart:io';
import 'package:carinspect/SpecialFeature.dart/Displaymusicsystem.dart';
...
class Exteriorlhssidelhsquaterpanel extends StatefulWidget {
  const Exteriorlhssidelhsquaterpanel({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidelhsquaterpanel> createState() =>
      _ExteriorlhssidelhsquaterpanelState();
}

class _ExteriorlhssidelhsquaterpanelState
    extends State<Exteriorlhssidelhsquaterpanel> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side LHS Quater Panel",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side LHS Quater Panel",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Displaymusicsystem(),
                          ),
                        );
