import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideAPiller.dart';
...
class Exteriorlhssidelhsfender extends StatefulWidget {
  const Exteriorlhssidelhsfender({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidelhsfender> createState() =>
      _ExteriorlhssidelhsfenderState();
}

class _ExteriorlhssidelhsfenderState extends State<Exteriorlhssidelhsfender> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side LHS Fender",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorlhssideapiller(),
                          ),
                        );
