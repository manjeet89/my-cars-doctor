import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideFrontLhsDoor.dart';
...
class Exteriorlhssidefrontlhswindow extends StatefulWidget {
  const Exteriorlhssidefrontlhswindow({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidefrontlhswindow> createState() =>
      _ExteriorlhssidefrontlhswindowState();
}

class _ExteriorlhssidefrontlhswindowState
    extends State<Exteriorlhssidefrontlhswindow> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side Front LHS Window",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side Front LHS Window",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorlhssidefrontlhsdoor(),
                          ),
                        );
