import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideLhsRunningBoard.dart';
...
class Exteriorlhssiderearlhswindow extends StatefulWidget {
  const Exteriorlhssiderearlhswindow({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssiderearlhswindow> createState() =>
      _ExteriorlhssiderearlhswindowState();
}

class _ExteriorlhssiderearlhswindowState
    extends State<Exteriorlhssiderearlhswindow> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side Rear LHS Window",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side Rear LHS Window",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Exteriorlhssidelhsrunningboard(),
                          ),
                        );
