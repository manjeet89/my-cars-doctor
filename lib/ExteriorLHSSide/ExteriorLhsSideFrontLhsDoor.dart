import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideRearLHSDoor.dart';
...
class Exteriorlhssidefrontlhsdoor extends StatefulWidget {
  const Exteriorlhssidefrontlhsdoor({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidefrontlhsdoor> createState() =>
      _ExteriorlhssidefrontlhsdoorState();
}

class _ExteriorlhssidefrontlhsdoorState
    extends State<Exteriorlhssidefrontlhsdoor> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side Front LHS Door",
            style: TextStyle(
              color: Colors.white,
        ...
        children: [
          Padding(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text(
                "Exterior LHS Side Front LHS Door",
                style: TextStyle(
                  color: Colors.black,
                  fontWeight: FontWeight.bold,
                  fontSize: 20,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorlhssiderearlhsdoor(),
                          ),
                        );
