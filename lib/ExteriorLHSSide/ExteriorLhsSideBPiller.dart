import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideFrontLhsWindow.dart';
...
class Exteriorlhssidebpiller extends StatefulWidget {
  const Exteriorlhssidebpiller({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidebpiller> createState() => _ExteriorlhssidebpillerState();
}

class _ExteriorlhssidebpillerState extends State<Exteriorlhssidebpiller> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side B Piller",
            style: TextStyle(
              color: Colors.white,
