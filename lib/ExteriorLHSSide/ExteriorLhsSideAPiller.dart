import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideBPiller.dart';
...
class Exteriorlhssideapiller extends StatefulWidget {
  const Exteriorlhssideapiller({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssideapiller> createState() => _ExteriorlhssideapillerState();
}

class _ExteriorlhssideapillerState extends State<Exteriorlhssideapiller> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side A Piller",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorlhssidebpiller(),
                          ),
                        );
