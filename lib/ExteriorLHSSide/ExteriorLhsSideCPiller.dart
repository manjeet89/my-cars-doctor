import 'dart:io';
import 'package:carinspect/ExteriorLHSSide/ExteriorLhsSideRearLhsTyrePercentage.dart';
...
class Exteriorlhssidecpiller extends StatefulWidget {
  const Exteriorlhssidecpiller({Key? key}) : super(key: key);

  @override
  State<Exteriorlhssidecpiller> createState() => _ExteriorlhssidecpillerState();
}

class _ExteriorlhssidecpillerState extends State<Exteriorlhssidecpiller> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Exterior LHS Side C Piller",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                Exteriorlhssiderearlhstyrepercentage(),
                          ),
                        );
