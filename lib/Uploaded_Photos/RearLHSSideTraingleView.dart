...
import 'package:carinspect/Uploaded_Photos/RearLHSTyre.dart';
...
class Rearlhssidetraingleview extends StatefulWidget {
  const Rearlhssidetraingleview({Key? key}) : super(key: key);

  @override
  State<Rearlhssidetraingleview> createState() =>
      _RearlhssidetraingleviewState();
}

class _RearlhssidetraingleviewState extends State<Rearlhssidetraingleview> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Rear LHS Side Traingle View",
            style: TextStyle(
              color: Colors.white,
