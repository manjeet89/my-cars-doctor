...
import 'package:carinspect/Uploaded_Photos/RHSSideView.dart';
...
class Frontrhstyre extends StatefulWidget {
  const Frontrhstyre({Key? key}) : super(key: key);

  @override
  State<Frontrhstyre> createState() => _FrontrhstyreState();
}

class _FrontrhstyreState extends State<Frontrhstyre> {
  File? _croppedImage;
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rhssideview()),
                        );
