...
class Frontglass extends StatefulWidget {
  const Frontglass({Key? key}) : super(key: key);

  @override
  State<Frontglass> createState() => _FrontglassState();
}

class _FrontglassState extends State<Frontglass> {
  File? _croppedImage;
