...
import 'package:carinspect/Uploaded_Photos/RearLHSSideTraingleView.dart';
...
class Sparewheeltyre extends StatefulWidget {
  const Sparewheeltyre({Key? key}) : super(key: key);

  @override
  State<Sparewheeltyre> createState() => _SparewheeltyreState();
}

class _SparewheeltyreState extends State<Sparewheeltyre> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Spare Wheel Tyre",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rearlhssidetraingleview(),
                          ),
                        );
