import 'dart:io';
import 'package:carinspect/Uploaded_Photos/DickyDoorOpenView.dart';
...
class Backsideview extends StatefulWidget {
  const Backsideview({Key? key}) : super(key: key);

  @override
  State<Backsideview> createState() => _BacksideviewState();
}

class _BacksideviewState extends State<Backsideview> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Dickydooropenview(),
                          ),
                        );
