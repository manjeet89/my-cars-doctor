...
import 'package:carinspect/Uploaded_Photos/FrontLHSTyre.dart';
...
class Rearinteriorview extends StatefulWidget {
  const Rearinteriorview({Key? key}) : super(key: key);

  @override
  State<Rearinteriorview> createState() => _RearinteriorviewState();
}

class _RearinteriorviewState extends State<Rearinteriorview> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Rear Interior View",
            style: TextStyle(
              color: Colors.white,
