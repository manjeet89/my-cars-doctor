...
import 'package:carinspect/Uploaded_Photos/RHSSideInteriorView.dart';
...
class Rhssideview extends StatefulWidget {
  const Rhssideview({Key? key}) : super(key: key);

  @override
  State<Rhssideview> createState() => _RhssideviewState();
}

class _RhssideviewState extends State<Rhssideview> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rhssideinteriorview(),
                          ),
                        );
