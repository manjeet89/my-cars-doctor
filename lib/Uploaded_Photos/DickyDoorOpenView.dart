import 'dart:io';
import 'package:carinspect/Uploaded_Photos/DickyFloorView.dart';
...
class Dickydooropenview extends StatefulWidget {
  const Dickydooropenview({Key? key}) : super(key: key);

  @override
  State<Dickydooropenview> createState() => _DickydooropenviewState();
}

class _DickydooropenviewState extends State<Dickydooropenview> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Dicky Door Open View",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Dickyfloorview(),
                          ),
                        );
