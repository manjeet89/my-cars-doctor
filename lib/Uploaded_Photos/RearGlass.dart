...
import 'package:carinspect/Uploaded_Photos/SpareWheelTyre.dart';
...
class Rearglass extends StatefulWidget {
  const Rearglass({Key? key}) : super(key: key);

  @override
  State<Rearglass> createState() => _RearglassState();
}

class _RearglassState extends State<Rearglass> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Sparewheeltyre(),
                          ),
                        );
