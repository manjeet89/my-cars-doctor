...
import 'package:carinspect/Uploaded_Photos/FrontRHSTyre.dart';
...
class Frontrhssidetriangleview extends StatefulWidget {
  const Frontrhssidetriangleview({Key? key}) : super(key: key);

  @override
  State<Frontrhssidetriangleview> createState() =>
      _FrontrhssidetriangleviewState();
}

class _FrontrhssidetriangleviewState extends State<Frontrhssidetriangleview> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Front RHS Side Triangle View",
            style: TextStyle(
              color: Colors.white,
