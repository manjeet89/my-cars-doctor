import 'dart:io';
import 'package:carinspect/Uploaded_Photos/DashboardView.dart';
...
class Frontlhstyre extends StatefulWidget {
  const Frontlhstyre({Key? key}) : super(key: key);

  @override
  State<Frontlhstyre> createState() => _FrontlhstyreState();
}

class _FrontlhstyreState extends State<Frontlhstyre> {
  File? _croppedImage;
