...
import 'package:carinspect/Uploaded_Photos/RearGlass.dart';
...
class Dickyfloorview extends StatefulWidget {
  const Dickyfloorview({Key? key}) : super(key: key);

  @override
  State<Dickyfloorview> createState() => _DickyfloorviewState();
}

class _DickyfloorviewState extends State<Dickyfloorview> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Dicky Floor View",
            style: TextStyle(
              color: Colors.white,
