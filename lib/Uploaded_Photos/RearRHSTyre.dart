import 'dart:io';
import 'package:carinspect/Uploaded_Photos/BackSideView.dart';
...
class Rearrhstyre extends StatefulWidget {
  const Rearrhstyre({Key? key}) : super(key: key);

  @override
  State<Rearrhstyre> createState() => _RoofState();
}

class _RoofState extends State<Rearrhstyre> {
  File? _croppedImage;
