...
import 'package:carinspect/Uploaded_Photos/Roof.dart';
...
class Enginecompatment extends StatefulWidget {
  const Enginecompatment({Key? key}) : super(key: key);

  @override
  State<Enginecompatment> createState() => _EnginecompatmentState();
}

class _EnginecompatmentState extends State<Enginecompatment> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Engine Compatment",
            style: TextStyle(
              color: Colors.white,
