...
import 'package:carinspect/Uploaded_Photos/RearInteriorView.dart';
...
class Lhssideview extends StatefulWidget {
  const Lhssideview({Key? key}) : super(key: key);

  @override
  State<Lhssideview> createState() => _LhssideviewState();
}

class _LhssideviewState extends State<Lhssideview> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rearinteriorview(),
                          ),
                        );
