...
import 'package:carinspect/Uploaded_Photos/LHSSideView.dart';
...
class Rearlhstyre extends StatefulWidget {
  const Rearlhstyre({Key? key}) : super(key: key);

  @override
  State<Rearlhstyre> createState() => _RearlhstyreState();
}

class _RearlhstyreState extends State<Rearlhstyre> {
  File? _croppedImage;
