...
class Thireddatashowinlistpage extends StatefulWidget {
  ...
  @override
  State<Thireddatashowinlistpage> createState() =>
      _ThireddatashowinlistpageState();
}

class _ThireddatashowinlistpageState extends State<Thireddatashowinlistpage> {
  String userid = "";
  String token = "";
  ...
  Widget build(BuildContext context) {
    ...
    print(widget.currentIndex.toString() + "worklinh");
    return Scaffold(
                                  ...
                                  try {
                                    ...
                                    if (response.statusCode == 200) {
                                      ...
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => Seconddatashowinlistpage(
                                            car: widget.car,
