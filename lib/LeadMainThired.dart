...
class Leadmainthired extends StatefulWidget {
  ...
  @override
  State<Leadmainthired> createState() => _LeadmainthiredState();
}

class _LeadmainthiredState extends State<Leadmainthired> {
  String userid = "";
  String token = "";
  String pcIsBoth = "0";
  bool stop = false;
    ...
    for (
      ...
      print(
        widget.pdilistoflead[i].pcId.toString() +
            ...
            " ==" +
            widget.dataload[widget.dataloadCurrentIndex].pcName.toString() +
