import 'dart:io';
import 'package:carinspect/SpecialFeature.dart/RearViewCamera.dart';
...
class Displaymusicsystem extends StatefulWidget {
  const Displaymusicsystem({Key? key}) : super(key: key);

  @override
  State<Displaymusicsystem> createState() => _DisplaymusicsystemState();
}

class _DisplaymusicsystemState extends State<Displaymusicsystem> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Display Music System",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rearviewcamera(),
                          ),
                        );
