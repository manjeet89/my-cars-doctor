import 'dart:io';
import 'package:carinspect/SpecialFeature.dart/driverSideAirbag.dart';
...
class Onekey extends StatefulWidget {
  const Onekey({Key? key}) : super(key: key);

  @override
  State<Onekey> createState() => _OnekeyState();
}

class _OnekeyState extends State<Onekey> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Driversideairbag(),
                          ),
                        );
