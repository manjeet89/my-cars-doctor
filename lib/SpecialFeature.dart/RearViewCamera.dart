import 'dart:io';
import 'package:carinspect/SpecialFeature.dart/oneKey.dart';
...
class Rearviewcamera extends StatefulWidget {
  const Rearviewcamera({Key? key}) : super(key: key);

  @override
  State<Rearviewcamera> createState() => _RearviewcameraState();
}

class _RearviewcameraState extends State<Rearviewcamera> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Rear View Camera In Screen",
            style: TextStyle(
              color: Colors.white,
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Onekey()),
                        );
