import 'dart:io';
import 'package:carinspect/SpecialFeature.dart/powerWindow.dart';
...
class Driversideairbag extends StatefulWidget {
  const Driversideairbag({Key? key}) : super(key: key);

  @override
  State<Driversideairbag> createState() => _DriversideairbagState();
}

class _DriversideairbagState extends State<Driversideairbag> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Driver Side Airbag",
            style: TextStyle(
              color: Colors.white,
