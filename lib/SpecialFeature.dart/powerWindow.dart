import 'dart:io';
import 'package:carinspect/Extra%20Damage/Damage.dart';
...
class Powerwindow extends StatefulWidget {
  const Powerwindow({Key? key}) : super(key: key);

  @override
  State<Powerwindow> createState() => _PowerwindowState();
}

class _PowerwindowState extends State<Powerwindow> {
  File? _croppedImage;
