import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/CPiller.dart';
...
class Rhsrunningboard extends StatefulWidget {
  const Rhsrunningboard({Key? key}) : super(key: key);

  @override
  State<Rhsrunningboard> createState() => _RhsrunningboardState();
}

class _RhsrunningboardState extends State<Rhsrunningboard> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo RHS Running Board",
            style: TextStyle(
              color: Colors.white,
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Cpiller()),
                        );
