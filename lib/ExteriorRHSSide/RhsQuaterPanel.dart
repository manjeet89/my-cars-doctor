import 'dart:io';
import 'package:carinspect/ExteriorBackSide/ExteriorBackSideDickyDoor.dart';
...
class Rhsquaterpanel extends StatefulWidget {
  const Rhsquaterpanel({Key? key}) : super(key: key);

  @override
  State<Rhsquaterpanel> createState() => _RhsquaterpanelState();
}

class _RhsquaterpanelState extends State<Rhsquaterpanel> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo RHS Quater Panel",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Exteriorbacksidedickydoor(),
                          ),
                        );
