import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RearRhsWindow.dart';
...
class Rearrhsdoor extends StatefulWidget {
  const Rearrhsdoor({Key? key}) : super(key: key);

  @override
  State<Rearrhsdoor> createState() => _RearrhsdoorState();
}

class _RearrhsdoorState extends State<Rearrhsdoor> {
  File? _croppedImage;
