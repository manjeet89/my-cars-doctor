import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/APiller.dart';
...
class Rhsfender extends StatefulWidget {
  const Rhsfender({Key? key}) : super(key: key);

  @override
  State<Rhsfender> createState() => _RhsfenderState();
}

class _RhsfenderState extends State<Rhsfender> {
  File? _croppedImage;
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Apiller()),
                        );
