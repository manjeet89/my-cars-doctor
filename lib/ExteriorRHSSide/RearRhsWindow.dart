import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RhsRunningBoard.dart';
...
class Rearrhswindow extends StatefulWidget {
  const Rearrhswindow({Key? key}) : super(key: key);

  @override
  State<Rearrhswindow> createState() => _RearrhswindowState();
}

class _RearrhswindowState extends State<Rearrhswindow> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Rear RHS Window",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rhsrunningboard(),
                          ),
                        );
