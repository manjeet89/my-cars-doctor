import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/FrontRhsDoor.dart';
...
class Frontrhswindow extends StatefulWidget {
  const Frontrhswindow({Key? key}) : super(key: key);

  @override
  State<Frontrhswindow> createState() => _FrontrhswindowState();
}

class _FrontrhswindowState extends State<Frontrhswindow> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Front RHS Window",
            style: TextStyle(
              color: Colors.white,
