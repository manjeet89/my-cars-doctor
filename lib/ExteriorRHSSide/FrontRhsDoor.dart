import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RearRhsDoor.dart';
...
class Frontrhsdoor extends StatefulWidget {
  const Frontrhsdoor({Key? key}) : super(key: key);

  @override
  State<Frontrhsdoor> createState() => _FrontrhsdoorState();
}

class _FrontrhsdoorState extends State<Frontrhsdoor> {
  File? _croppedImage;
