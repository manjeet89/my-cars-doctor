import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RearRhsTyrePercentage.dart';
...
class Cpiller extends StatefulWidget {
  const Cpiller({Key? key}) : super(key: key);

  @override
  State<Cpiller> createState() => _CpillerState();
}

class _CpillerState extends State<Cpiller> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rearrhstyrepercentage(),
                          ),
                        );
