import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RhsQuaterPanel.dart';
...
class Rearrhstyrepercentage extends StatefulWidget {
  const Rearrhstyrepercentage({Key? key}) : super(key: key);

  @override
  State<Rearrhstyrepercentage> createState() => _RearrhstyrepercentageState();
}

class _RearrhstyrepercentageState extends State<Rearrhstyrepercentage> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Rear RHS Tyre Percentage",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Rhsquaterpanel(),
                          ),
                        );
