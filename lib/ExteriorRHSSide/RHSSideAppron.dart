import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/FrontRHSTyrePercentage.dart';
...
class Rhssideappron extends StatefulWidget {
  const Rhssideappron({Key? key}) : super(key: key);

  @override
  State<Rhssideappron> createState() => _RhssideappronState();
}

class _RhssideappronState extends State<Rhssideappron> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo RHS Side Appron",
            style: TextStyle(
              color: Colors.white,
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Frontrhstyrepercentage(),
                          ),
                        );
