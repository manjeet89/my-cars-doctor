import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/FrontRHSWindow.dart';
...
class Bpiller extends StatefulWidget {
  const Bpiller({Key? key}) : super(key: key);

  @override
  State<Bpiller> createState() => _BpillerState();
}

class _BpillerState extends State<Bpiller> {
  File? _croppedImage;
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => Frontrhswindow(),
                          ),
                        );
