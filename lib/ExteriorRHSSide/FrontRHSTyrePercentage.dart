import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/RHSFender.dart';
...
class Frontrhstyrepercentage extends StatefulWidget {
  const Frontrhstyrepercentage({Key? key}) : super(key: key);

  @override
  State<Frontrhstyrepercentage> createState() => _FrontrhstyrepercentageState();
}

class _FrontrhstyrepercentageState extends State<Frontrhstyrepercentage> {
  File? _croppedImage;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Center(
          child: Text(
            "Uploaded Photo Front RHS Tyre Percentage",
            style: TextStyle(
              color: Colors.white,
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Rhsfender()),
                        );
