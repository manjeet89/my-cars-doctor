import 'dart:io';
import 'package:carinspect/ExteriorRHSSide/BPiller.dart';
...
class Apiller extends StatefulWidget {
  const Apiller({Key? key}) : super(key: key);

  @override
  State<Apiller> createState() => _ApillerState();
}

class _ApillerState extends State<Apiller> {
  File? _croppedImage;
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => Bpiller()),
                        );
